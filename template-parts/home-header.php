...
<header class="site-header site-header--homepage" id="top">
  <div class="shell site-header__inner">
    ...
    <nav class="desktop-nav" aria-label="Homepage navigation"><ul class="desktop-nav__list">
      <li><a href="<?php echo esc_url(home_url('/#services')); ?>">Services</a></li><li><a href="<?php echo esc_url(home_url('/#programming')); ?>">Programming</a></li><li><a href="<?php echo esc_url(home_url('/#advocacy')); ?>">Advocacy</a></li><li><a href="<?php echo esc_url(home_url('/#clients')); ?>">Clients</a></li><li><a href="<?php echo esc_url(home_url('/past-work/')); ?>">Past Work</a></li><li><a href="<?php echo esc_url(home_url('/#team')); ?>">Team</a></li><li><a href="<?php echo esc_url(home_url('/contact-us/')); ?>">Contact</a></li>
    </ul></nav>
  ...
  <div class="mobile-menu" id="mobile-menu" hidden><a href="<?php echo esc_url(home_url('/#services')); ?>">Services</a><a href="<?php echo esc_url(home_url('/#programming')); ?>">Programming</a><a href="<?php echo esc_url(home_url('/#advocacy')); ?>">Advocacy</a><a href="<?php echo esc_url(home_url('/#clients')); ?>">Clients</a><a href="<?php echo esc_url(home_url('/past-work/')); ?>">Past Work</a><a href="<?php echo esc_url(home_url('/contact-us/')); ?>">Contact</a><div class="mobile-menu__actions"><a class="button button--pill" href="<?php echo esc_url(home_url('/book-a-call/')); ?>">Book a Call <span aria-hidden="true">↗</span></a></div></div>
</header>

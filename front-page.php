...
<main id="main">
  ...
  <section class="section shell" id="clients">
    ...
    <div class="brand-marquee" aria-label="Selected clients"><div><?php for ($ticker_copy = 0; $ticker_copy < 2; $ticker_copy++) : ?><div class="brand-marquee__set"<?php echo $ticker_copy ? ' aria-hidden="true"' : ''; ?>><?php foreach (['INEC','AGRA','MO IBRAHIM FOUNDATION','WOTCLEF','AFRICAN ACHIEVERS AWARD','NCDC','SLOT','SSANU'] as $name) : ?><span><?php echo esc_html($name); ?> <b>/</b></span><?php endforeach; ?></div><?php endfor; ?></div></div>
    <?php $brands = [

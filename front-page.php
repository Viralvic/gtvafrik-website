...
<main id="main">
  ...
  <section class="section shell" id="clients">
    ...
    ]; $opaque_logos = ['APC-All-Progressives-Congress.png','HyperCITY.jpg','NCDC-North-Central-Development-Commission.jpg','NEXCO-Elevators.jpg','PDP-Peoples-Democratic-Party.png']; ?><div class="brand-grid"><?php foreach ($brands as $brand) : $logo = gtvafrik_media_url($brand[0]); ?><div class="brand-tile<?php echo in_array($brand[0], $opaque_logos, true) ? ' brand-tile--opaque' : ''; ?>"><?php if ($logo) : ?><img src="<?php echo esc_url($logo); ?>" alt="<?php echo esc_attr($brand[1]); ?> logo" loading="lazy"><?php else : echo esc_html($brand[1]); endif; ?></div><?php endforeach; ?><div class="brand-tile brand-tile--text"><strong>TMG</strong><small>Tinubu Mega Group</small></div></div>
  </section>

...
<main id="main">
  ...
  <section class="section shell contact" id="contact"><div class="contact__grid">
    <div><p class="eyebrow">/ Start a conversation</p><h2>Let's put your<br>story <span class="accent">on air.</span></h2><p>Have a brief, a big question or just a spark? Send it through. We'll come back with a point of view.</p><a class="contact__email" href="mailto:info@gtvafrik.com">info@gtvafrik.com</a><br><a class="button button--ghost contact__whatsapp" href="https://wa.me/2348188059300" target="_blank" rel="noopener">WhatsApp</a></div>
